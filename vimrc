"set runtimepath+=/usr/bin/vim-addons
...
set hlsearch
set modelines=1
" Use 256 terminal colors instead of 8.
set t_Co=256 

" View man pages in a vim window using, e.g.,
" :Man 3 echo
...
"highlight Text ctermfg=lightgray
highlight Comment ctermfg=red
highlight String ctermfg=green
highlight Visual term=reverse cterm=reverse ctermbg=black
highlight SpecialKey term=bold ctermfg=cyan
highlight NonText term=bold ctermfg=cyan
highlight Directory term=bold ctermfg=cyan
highlight Search term=reverse ctermfg=black
